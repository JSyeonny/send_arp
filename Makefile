...
# Project:  ../send_arp/send_arp.pro
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../send_arp/send_arp.pro
#############################################################################
...
INCPATH       = -I../send_arp -I. -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = send_arp1.0.0
DISTDIR = /root/Network/build-send_arp-Desktop_Qt_5_7_0_GCC_64bit-Debug/.tmp/send_arp1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap 
AR            = ar cqs
...
DIST          = /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../send_arp/send_arp.pro  ../send_arp/main.cpp
...
Makefile: ../send_arp/send_arp.pro /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/lex.prf \
		../send_arp/send_arp.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../send_arp/send_arp.pro
...
main.o: ../send_arp/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../send_arp/main.cpp
